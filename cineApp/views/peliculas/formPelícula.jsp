...
<html lang="en">
  ...
  <body>
	...
	<h3 class="blog-title"><span class="label label-success">Datos de la Pelicula</span></h3>
		...
		<spring:hasBindErrors name="película">
		...
		${película}
      <form:form action="${urlForm}" method="post" enctype="multipart/form-data" modelAttribute="película">
        <div class="row">
          <div class="col-sm-3">
            <div class="form-group">
              <img class="img-rounded" src="${urlPublic}/images/${película.imagen}" title="Imagen actual de la película" width="150" height="200">
            </div>  
          </div>
        </div>
        ...
        <div class="row">
          <div class="col-sm-3">
            <div class="form-group">
              ...
              <form:hidden path="id"/>
              <form:input type="text" class="form-control" path="título" id="título" required="required" />
            </div>  
          </div>
          <div class="col-sm-3">
            <div class="form-group">
              <label for="duracion">Duracion</label>
              <form:input type="text" class="form-control" path="duración" id="duración" required="required" />
            </div>  
          </div>
          <div class="col-sm-3">
            <div class="form-group">
              <label for="clasificacion" class="control-label">Clasificacion</label>              
              <form:select id="clasificación" path="clasificación" class="form-control">
          ...
          <div class="col-sm-3">
            <div class="form-group">
             ...
             <form:select id="género" path="género" class="form-control" items="${géneros}"/>
            <%--
                            
              <form:select id="género" path="género" class="form-control">
