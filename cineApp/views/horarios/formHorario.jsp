...
<html lang="en">
	...
	<body>
		...
		${horario}
			<form:form class="form-horizontal" method="post" action="${urlRoot}horarios/save" modelAttribute="horario">
				<div class="row">         
					<div class="col-sm-3">
						<div class="form-group">
							<label for="idPelicula" class="control-label">Pelicula</label>              
							<form:select path="película.id" class="form-control" items="${películas}" itemValue="id" itemLabel="título"/>	              
